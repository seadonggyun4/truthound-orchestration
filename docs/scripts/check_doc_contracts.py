...
def main() -> int:
    ...
    checks = [
        ...
        _require(ROOT / "mkdocs.yml", "i18n:"),
        _require(ROOT / "mkdocs.yml", "docs_structure: folder"),
        _require(ROOT / "docs/i18n/en/index.md", "official first-party orchestration"),
        _require(ROOT / "docs/i18n/ko/index.md", "한국어 문서"),
