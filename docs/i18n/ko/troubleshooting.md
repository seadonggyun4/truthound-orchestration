...
Use this page when a first run, CI job, or production 워크플로우 fails and you need to quickly determine whether the problem lives in host wiring, shared runtime normalization, engine support, or result serialization.
...
| 워크플로우 runs but observability, retries, or health signals are unclear | shared runtime operations | [Observability and Resilience](common/observability-resilience.md) |
...
## Airflow 오케스트레이션 Can Read Files But Not SQL
